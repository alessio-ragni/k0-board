...
/**
 * The one walk through the text, which produces both numbers this file exists for: how alike the
 * two are, and **which letters** made it so.
 *
...
function trace(text, q) {
  ...
  return { total: total - s.length * 0.01, at }
}
